...
[Live demo](https://vortex-sui.vercel.app) · [Docs](https://docs-vortex.vercel.app) · [Architecture](#architecture) · [How it works](#how-it-works) · [Deployment](#live-testnet-deployment) · [Quick start](#quick-start) · [Keeper](#keeper-automation)
...
[Live demo](https://vortex-sui.vercel.app) · [Docs](https://docs-vortex.vercel.app) · [DEMO.md](DEMO.md) · [SIMULATION.md](SIMULATION.md)
